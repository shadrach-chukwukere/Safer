...
export default function JoinSafer() {
  return (
    <div className="px-4 sm:px-0 pt-8 sm:pt-12 space-y-14 mx-3 lg:mx-16">
      
      {/* First Section */}
      <motion.div
        className="py-12 font-Inter"
        initial="hidden"
        whileInView="visible"
      ...
      >
        <div className="grid md:grid-cols-2 justify-items-center items-center gap-10">
          ...
          <div className="space-y-12 text-center md:text-left flex flex-col items-center md:items-start">
            <motion.p
              className="font-medium max-w-[500px] text-[32px] sm:text-[40px] md:text-[45px] leading-[1.1]"
              variants={itemVariants}
            >
              Different smart options to start a transaction, Snap, scan, upload
            </motion.p>
            <motion.p
              className="font-medium text-[15px] sm:text-[16px] md:text-[22px] max-w-[560px]"
              variants={itemVariants}
            >
      ...
      <div className="grid md:grid-cols-2 gap-12 md:auto-rows-fr justify-center justify-items-center">
        ...
        <motion.div
          ...
          style={{ background: "linear-gradient(to right top , #0A495A 0% , #1A4077)" }}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.2 }}
          variants={containerVariants} // Only used for staggering inner text + images
        >
          <motion.div
