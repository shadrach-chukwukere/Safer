  ...
  return (
    <div className="lg:mx-10  mx-0 px-6 py-12 leading-snug font-Inter">
      ...
      <p className="mb-4 font-medium text-lg">
        Welcome to <strong>Safer</strong>, the AI-powered payment app by <strong>Safer
        Technologies Limited</strong>. At Safer, your privacy is our top priority. This
      ...
      <ul className="list-disc list-inside space-y-1 font-medium text-lg">
        ...
        <li>Enhance your experience with AI-powered smart payment features</li>
      ...
      <h2 className="text-lg font-bold mt-6 mb-2">Voice & Image Processing</h2>
      <ul className="list-disc list-inside space-y-1 font-medium text-lg">
        <li>
          Voice notes or images may be temporarily processed by AI to extract
          financial info ( e.g., account number, reference ).
        </li>
        <li>Personal identifiers are anonymized or removed where possible.</li>
        <li>
      ...
      <p className="mt-2 font-medium flex items-center gap-2">
        <AiOutlineCheckCircle className="text-lg" /> All partners follow strict
        data protection standards. Data is only shared when required for service
      ...
      <p className="mt-2 font-medium text-lg">
        ...
        <a
          href="mailto:privacy@saferapp.com"
          className="text-blue-600 font-semibold underline"
        >
          privacy@saferapp.com
        </a>
      </p>
      ...
      <p className="font-medium text-lg">
        ...
        collect data from minors. If discovered, it will be deleted immediately.
      </p>
      ...
      <p className="font-medium text-lg">
        ...
        will be notified through the app, email, or website.
      </p>
