...
export default function Terms() {
  return (
    <>
      <PageMeta
        title="Terms & Conditions | Safer"
        description="Read the terms and conditions governing your use of SmartSafer. Learn about user responsibilities, account usage, and legal policies."
        keywords="SmartSafer, terms, conditions, user agreement, legal, policy"
      />
      ...
      <div className="lg:mx-10 mx-0 px-6 py-12 leading-snug font-Inter">
        ...
        <ul className="list-disc list-inside font-medium text-lg space-y-1">
          ...
          <li>
            Use of the Platform is subject to compliance with applicable laws
            and regulations ( e.g., CBN, AML/CFT, data protection laws ).
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside font-medium text-lg space-y-1">
          ...
          <li>
            We are not liable for downtime, delays, or technical errors beyond
            our control.
          </li>
          <li>
            We are not responsible for incorrect user input or third-party
            system failures.
          </li>
          <li>
          ...
          <li>
            Our maximum liability shall not exceed the amount of fees paid by
        ...
        <ul className="list-disc list-inside font-medium text-lg space-y-1">
          ...
          <li>
            Fraudulent, illegal, or suspicious activity may result in
            termination.
          </li>
          <li>
        ...
        <p className="font-medium text-lg">
          ...
          communicated via email, in-app notifications, or our website.
        ...
        <p className="font-medium text-lg">
          ...
          Nigeria. Disputes shall first be resolved amicably, then referred to
          arbitration in Lagos, Nigeria if unresolved.
        </p>
        ...
        <p className="font-medium text-lg flex items-center gap-2 mt-1">
          <FiMapPin className="text-lg" /> Address: Lekki , Lagos Nigeria.
        </p>
      </div>
    </>
  );
